...
<template>
    <div>
        ...
        <Modal
            ...
            <p>姓名：{{this.detail.contact_name}}</p>
            <p>联系号码：{{this.detail.contact_phone}}</p>
            <p>申请理由：{{this.detail.sign_up_reason}}</p>
...
<script type="text/ecmascript-6">
    import {signList, removeSignList} from '@/api/activity'
    ...
    export default {
        ...
        methods: {
            ...
            signDetail(data) {
                ...
                this.detail = {
                    ...
                    sign_up_reason: data.sign_up_reason,
        ...
        computed: {
            ...
            viewAccessAll() {
                ...
                const item = ['Delete:/admin/activity/sign']
                const arr = ['*']
